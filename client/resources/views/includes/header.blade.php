    ...
    <div class="container-fluid">
        ...
        <div class="order-lg-2">
            ...
            <div class="header-icon-wrap">
                ...
                <div class="header-cart-icon">
                    ...
                    <div class="header-cart-quantity rounded-circle d-flex justify-content-center align-items-center">
                        <span>3</span>
                    </div>
        ...
        <div class="order-lg-1 collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/location">CỬA HÀNG</a>
                </li>
            ...
            <form class="header-form-search d-flex align-items-center" role="search">

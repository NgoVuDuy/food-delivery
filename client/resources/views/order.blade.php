                ...
                <div class="order-wrap">
                    ...
                    <div class="order-status d-flex align-items-center">
                        ...
                        <div class="approval-icon-wrap status-icon">
                            ...
                            <svg class="approval-icon" xmlns="http://www.w3.org/2000/svg" width="26"
                        ...
                        <div class="checked-icon-wrap status-icon">
                            ...
                            <svg class="checked-icon " xmlns="http://www.w3.org/2000/svg" width="26"
                                height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <div class="cooking-icon-wrap status-icon">
                            ...
                            <svg class="cooking-icon " xmlns="http://www.w3.org/2000/svg" width="26"
                                height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <div class="home-icon-wrap status-icon">
                            ...
                            <svg xmlns="home-icon http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24"

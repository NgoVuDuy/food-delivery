<div>
    ...
    <div class="modal fade modal-form modal-signup" id="signupModal" tabindex="-1" aria-labelledby="signupModal" aria-hidden="true"
        wire:ignore.self>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="d-flex column-gap-4 justify-content-center title-wrap">
                        ...
                        <h1 class="modal-title fs-5 sign-in-title" data-bs-toggle="modal" data-bs-target="#signinModal">Đăng Nhập</h1>
                        <h1 class="modal-title fs-5 sign-up-title">Đăng Ký</h1>
                    </div>
                            ...
                            <div class="col-7">
                                ...
                                <div class="form-wrap d-flex flex-column row-gap-4">
                                    ...
                                    <div class="">
                                        ...
                                        <input id="name" class="form-control" type="search" placeholder="Nhập Mật Khẩu">
                                    </div>

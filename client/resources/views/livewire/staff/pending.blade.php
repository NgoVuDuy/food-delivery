...
@section('slot')
    <div class="container-fluid table-mt {{ empty($pending_orders) ? '' : 'd-none' }}">
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="" wire:poll.10s="refreshData">
                            ...
                            @foreach ($pending_orders as $pending_order)
                                <tr>
                                    ...
                                    <td class="d-none d-lg-table-cell d-md-table-cell">{{ $pending_order['total_price'] }}
                                    </td>
                                    ...
                                    @if (!empty(session('user')['staff']))
                                        <td class="checked-wrap"><button class="checked-btn"
                                                wire:click="pending_conform({{ $pending_order['id'] }})">Xác nhận</button>
                                        </td>
                                    @endif

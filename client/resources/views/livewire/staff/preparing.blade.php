                        ...
                        {{-- <div class="" wire:poll.30s="refreshData"> --}}
                            ...
                            @foreach ($preparing_orders as $preparing_order)
                                <tr>
                                    ...
                                    <td>{{ $preparing_order['total_price'] }}</td>
                                ...
                                <!-- Modal -->
                                <div class="modal fade order-details" id="details{{ $preparing_order['id'] }}" tabindex="-1"
                                    aria-labelledby="details{{ $preparing_order['id'] }}" aria-hidden="true">
                                                                ...
                                                                <div class="d-flex flex-column row-gap-3 wrap">
                                                                    ...
                                                                    <div class="card-delivery-address d-flex">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <span>{{ $preparing_order['place_name'] }}</span>
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <span>{{ $preparing_order['store_location']['name'] }}</span>
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <span>{{ $preparing_order['name'] }}</span>
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <span>{{ $preparing_order['phone'] }}</span>
                                                                        </div>

                    ...
                    <table>
                        ...
                        {{-- <div class="" wire:poll.30s="refreshData"> --}}
                            ...
                            @foreach ($delivering_orders as $delivering_order)
                                <tr>
                                    <td>{{ $delivering_order['id'] }}</td>
                                    <td>{{ $delivering_order['payment_method'] }}</td>
                                    <td>{{ $delivering_order['total_price'] }}</td>
                                    <td>{{ $delivering_order['created_at'] }}</td>
                                    <td class="text-center">{{ $delivering_order['shipper']['user']['name'] }}</td>

                                    <td><span class="details-btn" data-bs-toggle="modal" data-bs-target="#details{{ $delivering_order['id'] }}">Xem chi
                                            tiết</span></td>
                                ...
                                <!-- Modal -->
                                <div class="modal fade order-details" id="details{{ $delivering_order['id'] }}" tabindex="-1"
                                    aria-labelledby="details{{ $delivering_order['id'] }}" aria-hidden="true">
                                                                ...
                                                                <div class="d-flex flex-column row-gap-3 wrap">
                                                                    ...
                                                                    <div class="card-delivery-address d-flex">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <span>{{ $delivering_order['place_name'] }}</span>
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <span>{{ $delivering_order['store_location']['name'] }}</span>
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <span>{{ $delivering_order['name'] }}</span>
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <span>{{ $delivering_order['phone'] }}</span>
                                                                        </div>
                                                        ...
                                                        <div class="col-8">
                                                            <div class="card-order-information rounded shadow p-3">
                                                                ...
                                                                <div class="d-flex row-gap-2 flex-column">
                                                                    ...
                                                                    @foreach ($delivering_order['order_items'] as $index => $order_item)
                                                                        <div
                                                                    ...
                                                                    <div class="d-flex justify-content-end column-gap-5 pt-3">
                                                                        ...
                                                                        <div class="sum-monney">
                                                                            {{ $delivering_order["total_price"] }}đ
                                                                        </div>
                                                                    </div>

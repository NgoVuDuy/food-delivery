...
@section('slot')
    <div class="container-fluid table-mt {{ empty($delivering_orders) ? '' : 'd-none' }}">
        <div class="row">
            <div class="col-12">
                            ...
                            @foreach ($delivering_orders as $delivering_order)
                                <tr>
                                    ...
                                    <td><span class="details-btn" data-bs-toggle="modal"
                                            data-bs-target="#details{{ $delivering_order['id'] }}">Xem chi
                                            tiết</span></td>
    ...
    @foreach ($delivering_orders as $delivering_order)
        ...
        <div class="modal fade order-details" id="details{{ $delivering_order['id'] }}" tabindex="-1"
            aria-labelledby="details{{ $delivering_order['id'] }}" aria-hidden="true" wire:ignore.seft>

                        ...
                        {{-- <div class="" wire:poll.30s="refreshData"> --}}
                            ...
                            @foreach ($completed_orders as $completed_order)
                                <tr>
                                    ...
                                    <td><span class="details-btn" data-bs-toggle="modal" data-bs-target="#details{{ $completed_order['id'] }}">Xem chi
                                            tiết</span></td>
    
                                </tr>
    
                                <!-- Modal -->
                                <div class="modal fade order-details" id="details{{ $completed_order['id'] }}" tabindex="-1"
                                    aria-labelledby="details{{ $completed_order['id'] }}" aria-hidden="true">
                                                                ...
                                                                <div class="d-flex flex-column row-gap-3 wrap">
                                                                    ...
                                                                    <div class="card-delivery-address d-flex">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <span>{{ $completed_order['place_name'] }}</span>
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <span>{{ $completed_order['store_location']['name'] }}</span>
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <span>{{ $completed_order['name'] }}</span>
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <span>{{ $completed_order['phone'] }}</span>
                                                                        </div>
                                                        ...
                                                        <div class="col-8">
                                                            <div class="card-order-information rounded shadow p-3">
                                                                ...
                                                                <div class="d-flex row-gap-2 flex-column">
                                                                    ...
                                                                    @foreach ($completed_order['order_items'] as $index => $order_item)
                                                                        <div

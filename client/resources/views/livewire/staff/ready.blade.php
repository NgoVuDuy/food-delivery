...
@section('slot')
    <div class="container-fluid table-mt {{ empty($ready_orders) ? '' : 'd-none' }}">
        <div class="row">
            <div class="col-12">
                    ...
                    <table>
                        ...
                        @foreach ($ready_orders as $ready_order)
                            <tr>
                                ...
                                <td class="d-none d-lg-table-cell d-md-table-cell">{{ $ready_order['total_price'] }}
                                </td>
    ...
    @foreach ($ready_orders as $ready_order)
        ...
        <div class="modal fade order-details" id="details{{ $ready_order['id'] }}" tabindex="-1"
            aria-labelledby="details{{ $ready_order['id'] }}" aria-hidden="true" wire:ignore.seft>

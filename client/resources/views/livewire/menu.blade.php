        ...
        <div class="row">
                ...
                <div class="menu-filter-wrap" wire:ignore>
                    ...
                    <div class="menu-filter-item mb-3">
                        ...
                        <div class="wrap">
                            ...
                            <button class="item" wire:click="category('Meat Lover\'s Pizza')"><span>Meat Lover's Pizza</span></button>
                            <button class="item" wire:click="category('Vegetarian Pizza')"><span>Vegetarian Pizza</span></button>
                            <button class="item" wire:click="category('Seafood Pizza')"><span>Seafood Pizza</span></button>
                            <button class="item" wire:click="category('Cheese Pizza')"><span>Cheese Pizza</span></button>
                            <button class="item" wire:click="category('Spicy Pizza')"><span>Spicy Pizza</span></button>
                        </div>
                    ...
                    <div class="menu-filter-item mb-3">
                        ...
                        <div class="wrap">
                            ...
                            <button class="item" wire:click="category('American Pizza')"><span>American Pizza</span></button>
                            <button class="item" wire:click="category('Chicago Deep Dish')"><span>Chicago Deep Dish</span></button>
                            <button class="item" wire:click="category('Japanese Pizza')"><span>Japanese Pizza</span></button>
                        </div>
                    ...
                    <div class="menu-filter-item mb-3">
                        ...
                        <div class="wrap">
                            ...
                            <button class="item" wire:click="category('Mỳ ý')"><span>Mỳ ý</span></button>
                            <button class="item" wire:click="category('Hamburger')"><span>Hamburger</span></button>
                            <button class="item" wire:click="category('Bánh ngọt')"><span>Bánh ngọt</span></button>
            ...
            <div class="col-9">
                ...
                <div class="sort-by-wrap d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <div class="filter-status-text">{{ $category_text }}</div>
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-5">
                        ...
                        <a href="menu/1" class="link" wire:navigate>
